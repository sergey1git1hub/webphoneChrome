    ...
    public static WebDriver setWebphoneResultCode(WebDriver driver) throws InterruptedException, UnknownHostException, FindFailed {
       ...
       /* String hostName = InetAddress.getLocalHost().getHostName();
        if (!isLocal()) {
            ...
            WebDriverWait waitForResultCode = new WebDriverWait(driver, 5);
            waitForResultCode.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#resultCodeTable_data > tr > td"))); //удачно

            WebElement resultCode = driver.findElement(By.cssSelector("#resultCodeTable_data > tr > td")); //удачно
